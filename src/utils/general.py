...
from src.utils.google_utils import gsutil_getsize
from src.utils.metrics import fitness
from src.utils.torch_utils import init_torch_seeds
...
def strip_optimizer(f='best.pt', s=''):  # from src.utils.general import *; strip_optimizer()
