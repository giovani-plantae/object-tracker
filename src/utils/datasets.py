...
from src.utils.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
...
def extract_boxes(path='../coco/'):  # from src.utils.datasets import *; extract_boxes('../coco128')
...
def autosplit(path='../coco', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from src.utils.datasets import *; autosplit('../coco')
    Arguments
